...
def decorate_content(original_message: str) -> str:
    decorated_message = (
        ...
        "2) Download the dYdX Ops Services public key from https://github.com/dydxopsdao/v4-infrastructure/blob/main/validator_notifier/dydxops-pubkey.pem as `dydxops-pubkey.pem`.\n"
        "3) Run:\n"
